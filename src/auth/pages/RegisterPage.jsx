...
// xs se refiere a la cantidad de columnas que ocupará el elemento en una pantalla extra pequeña
// sx es una prop especial de Material-UI que permite aplicar estilos de CSS en línea
  ...
  return (
    ...
    <AuthLayout title="Crear cuenta">
      <form onSubmit={onSubmit} className="animate__animated animate__fadeIn animate__faster">
        <Grid container>
          <Grid item xs={12} sx={{ mt: 2 }}>
            <TextField label="Nombre completo" type="text" placeholder="Tu nombre" fullWidth
              ...
              //{Si displayNameValid es true y formSubmitted es true, entonces error es true }
        ...
        <Grid container direction='row' justifyContent='end' spacing={2} sx={{ mb: 2, mt: 1 }}>
